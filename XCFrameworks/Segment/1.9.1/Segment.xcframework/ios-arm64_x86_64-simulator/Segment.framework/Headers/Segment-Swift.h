...
/// Opt-in/out of tracking lifecycle events.  The default value is <code>true</code>.
...
SWIFT_CLASS("_TtC7Segment21TrackedLifecycleEvent")
@interface TrackedLifecycleEvent : NSObject
