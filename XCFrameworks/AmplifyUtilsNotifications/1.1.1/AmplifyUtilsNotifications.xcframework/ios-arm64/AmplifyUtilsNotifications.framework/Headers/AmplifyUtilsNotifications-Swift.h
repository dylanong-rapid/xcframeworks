...
#ifndef AMPLIFYUTILSNOTIFICATIONS_SWIFT_H
#define AMPLIFYUTILSNOTIFICATIONS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AmplifyUtilsNotifications",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC25AmplifyUtilsNotifications21AUNotificationService")
@interface AUNotificationService : UNNotificationServiceExtension
